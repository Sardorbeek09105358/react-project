...
function LoginForm() {
  ...
  return (
    ...
    <h1 className='text-center capitalize text-5xl mt-2 mb-3 font-bold lg:text-4xl md:text-3xl sm:text-xl'>login</h1>
    ...
    <div className='w-full flex flex-col justify-between pl-5 pr-5 animate__animated animate__fadeIn'>
        <p className='capitalize mb-3'>email</p>
        <input type="email" value={email} onChange={handleEmailChange} placeholder='enter your email' className='w-[100%] h-14 pl-4 capitalize outline-none' required/>
    </div>

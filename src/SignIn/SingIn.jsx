    ...
    return (
        ...
        <div className='flex w-[90%] justify-between h-[100vh] items-center m-auto gap-10 lg:mt-[100px] md:pt-14 lg:pt-14 lg:flex-col lg:md-[300px] md:flex-col md:items-center animate__animated animate__fadeIn'>
            <div className='w-[50%] md:w-[90%] m-auto sm:w-[90%] lg:w-[90%]'>
                ...
                <div>
                    <div className='w-[100%] h-[200px] md:w-[100%] lg:w-[100%] bg-white flex flex-col justify-around items-center rounded border-2 sm:w-[100%]'>
                        ...
                        <div className='flex w-[90%] justify-between max-[500px]:items-center'>
                    ...
                    <div className='flex gap-4 mt-3 justify-end'>
                        <div className='w-14 h-11 border rounded bg-white flex justify-center pt-3 animate__animated animate__bounceInLeft'>
                            <i className="fa-solid fa-arrow-left"></i>   
                        </div>  
                        <div className='w-14 h-11 border rounded bg-white flex justify-center pt-3 animate__animated animate__bounceInRight'>
